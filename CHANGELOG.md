...
## [1.6.0](https://github.com/GeekGroveCode/vibesdk/compare/v1.5.0...v1.6.0) (2026-02-15)


### Features

* add abort signal support to inference operations ([f3e545e](https://github.com/GeekGroveCode/vibesdk/commit/f3e545e742b7b4cedb4c74b3af9501327ee8a8b3))
...
* add deep debug session management with state persistence and wait tools ([e60694f](https://github.com/GeekGroveCode/vibesdk/commit/e60694f6334b2c05acd1c7147650fc88c9adbd61))
* add deep debugger transcript UI with collapsible tool results ([95ed92f](https://github.com/GeekGroveCode/vibesdk/commit/95ed92f0111bab5f78318a810c9c965afc38a388))
...
* add duration filter option for log retrieval in sandbox ([4579da2](https://github.com/GeekGroveCode/vibesdk/commit/4579da2530a45d91294fd108d9937254d93e68de))
...
* add force refresh mechanism for preview deployments ([796e34d](https://github.com/GeekGroveCode/vibesdk/commit/796e34d3459657502599bdbfdeddc1144289c0e3))
* add generate_files tool for creating new files and full rewrites ([52d917f](https://github.com/GeekGroveCode/vibesdk/commit/52d917f2f6ff39f2ea047f494cf579e28dab9a31))
...
* add inference cancellation support with AbortController ([6e752c2](https://github.com/GeekGroveCode/vibesdk/commit/6e752c214197ec755c988ee0308721d1f04b50fb))
...
* add previous debug session context and improve error handling in debugging tools ([45ac910](https://github.com/GeekGroveCode/vibesdk/commit/45ac9105ad920e36cd7b284a050a414c1913a2a6))
...
* add stop generation button and handle cancelled state in phase timeline ([3cd7cab](https://github.com/GeekGroveCode/vibesdk/commit/3cd7cabed64f8cbd012f12f63b5be6355b9a51e4))
* add streaming support to deep debugger and enhance logs tool with truncation ([1bdb1e7](https://github.com/GeekGroveCode/vibesdk/commit/1bdb1e7e97c6a18ae3c3a2c69b8c14e6fdd65a19))
...
* add tool result field to websocket messages and update event handling ([41fab81](https://github.com/GeekGroveCode/vibesdk/commit/41fab814b6991895da1cd9eccb2acac00a6f79a4))
...
* add wait_for_generation tool and enhance tool call result handling ([92f4e0e](https://github.com/GeekGroveCode/vibesdk/commit/92f4e0e5192efd8ca0154e7d28ba6fd1f046a8da))
...
* alter template schema to return map instead of list of files ([fad85df](https://github.com/GeekGroveCode/vibesdk/commit/fad85df3b1385426fb3892d74fb97f9f4dd2d52d))
...
* display completion message when entering finalization phase ([1365eeb](https://github.com/GeekGroveCode/vibesdk/commit/1365eebae9fc150a91d048bae2e6b5cf11cda350))
...
* enhance debugging tools with user interaction handling and runtime error detection ([b144e2c](https://github.com/GeekGroveCode/vibesdk/commit/b144e2c8b63bdf803f28b0ad85f8183ae6281316))
...
* enhance template file filtering with pattern matching and add nanoid generator ([68678ac](https://github.com/GeekGroveCode/vibesdk/commit/68678ac3a06b71d936a8b5f8e9e146b093d6d9a0))
...
* implement collapsible tool result viewer with JSON formatting support ([9ae4640](https://github.com/GeekGroveCode/vibesdk/commit/9ae464050cad6a55aa10f87df01f0739ccc00364))
* implement message deduplication to prevent duplicate assistant responses ([0256634](https://github.com/GeekGroveCode/vibesdk/commit/0256634a6a042d7136a6b9bcda80ea92a8d1478c))
...
* implement project name and blueprint update tools ([871548f](https://github.com/GeekGroveCode/vibesdk/commit/871548febfdcf6efd5d3fade563f8a7738f64e08))
...
* in memory get template details ([e01f067](https://github.com/GeekGroveCode/vibesdk/commit/e01f067969e1ad414257a312d7c887216c06fe46))
...
* initial implementation of deep debugging agent ([520c2f6](https://github.com/GeekGroveCode/vibesdk/commit/520c2f61fc5d6a012c45a5cb487fc728e2be3fb4))
...
* make deterministic code fixer completely sync ([23f0261](https://github.com/GeekGroveCode/vibesdk/commit/23f0261d9079c9c2991074180c8b5468af0e085a))
* more prompt tweaks for react/frontend ([866c881](https://github.com/GeekGroveCode/vibesdk/commit/866c881612adcbf1f658d63d20caeddee42c6602))
...
* prompt refinements for zustand ([ff604c6](https://github.com/GeekGroveCode/vibesdk/commit/ff604c6fafa42be76431d3dd8038edc9b4a71aa5))
...
* purely in-isolate template unzip + inmemory storage ([3cd14ed](https://github.com/GeekGroveCode/vibesdk/commit/3cd14ed58a4fe786523a4e5c63348c0b2671ee78))
* readme update ([33f72ab](https://github.com/GeekGroveCode/vibesdk/commit/33f72ab3dea70c1bc2c13e9ce30f79caa1c99422))
* redact older phase details to optimize context length in prompts ([2cd720e](https://github.com/GeekGroveCode/vibesdk/commit/2cd720ea26e6c03dcdeb250b4d93546da1f52d91))
...
* sandboxsdk 0.4.3 port + in-memory template details zip extraction ([fd63813](https://github.com/GeekGroveCode/vibesdk/commit/fd638136bc7261869fefbef2692ec488adabc5d9))
...
* add missing await for async getFullState call in getAgentState function ([b0afd15](https://github.com/GeekGroveCode/vibesdk/commit/b0afd1533f736976367e8a3585a7d260d76fd8c4))
...
* build errors ([3898da4](https://github.com/GeekGroveCode/vibesdk/commit/3898da495ec78526b36bf8c6657d5b89d45cefac))
...
* code debugger prompt improvements ([06375ce](https://github.com/GeekGroveCode/vibesdk/commit/06375ce09891d311acc8b283391d2378a50f35f0))
* concurrent deploy + use nanoid + stalestate ([ee61d46](https://github.com/GeekGroveCode/vibesdk/commit/ee61d464fbcd712a20ff822bdb76e0cf881e1aa3))
...
* disabled tracing causing deployment failures for non-GA ([1fa292e](https://github.com/GeekGroveCode/vibesdk/commit/1fa292ea92642992c867ee0a004fe1ed71a80c79))
...
* fileRegeneration was using realtimeCodeFixer's model config ([989aa1b](https://github.com/GeekGroveCode/vibesdk/commit/989aa1bf9c649558bd4aa959c906cf438be29ef6))
...
* finish posting to files map ([b73557e](https://github.com/GeekGroveCode/vibesdk/commit/b73557e4ed141191aba31a1fd6dceb7cbb86ec14))
...
* Fixed filtering important files ([d3d4776](https://github.com/GeekGroveCode/vibesdk/commit/d3d47769a7331523c2e2cb4c07b5408e3b7c862f))
...
* fixed setup project broken ([6a48871](https://github.com/GeekGroveCode/vibesdk/commit/6a4887103e388784def70ee12b15c916ee2b3eb2))
* generation context template details passing ([2b761d0](https://github.com/GeekGroveCode/vibesdk/commit/2b761d0d3d45d43206212f1166b98fb8dbcf3732))
...
* handle missing sandbox instance by returning empty issues object ([1259176](https://github.com/GeekGroveCode/vibesdk/commit/1259176c3b77500c4d145207f33d4a29cad20d74))
* handle parent dir creation in sandbox ([262bf69](https://github.com/GeekGroveCode/vibesdk/commit/262bf691ace3b66212128f18278e8f9fe348a0ec))
...
* log results object correctly and suppress init error propagation in generator agent ([bb0d97e](https://github.com/GeekGroveCode/vibesdk/commit/bb0d97e3236bf048f2bb5aa545a1b50fae86e81e))
...
* only generate AI proxy vars when JWT secret is configured ([701fe81](https://github.com/GeekGroveCode/vibesdk/commit/701fe8171b7098f0d470f8a56a9ae50b394f924f))
...
* prevent null ruleId in ESLint diagnostic messages by providing empty string fallback ([b76d000](https://github.com/GeekGroveCode/vibesdk/commit/b76d000b919ddf4cdeb36891afa6078325f8e59c))
...
* prevent reuse of aborted controllers and improve sandbox deployment resilience ([d5092b0](https://github.com/GeekGroveCode/vibesdk/commit/d5092b0c1757071efedd9c5a10677691e5497040))
...
* prompt react fixes ([0c3a841](https://github.com/GeekGroveCode/vibesdk/commit/0c3a841b72497bd97169de907a806d8527ff0abd))
...
* remove hardcoded models ([b98f862](https://github.com/GeekGroveCode/vibesdk/commit/b98f86280dd802cb226dd2d7e836e6ee8b713b5e))
...
* rendering and migration for template details change ([af1ba31](https://github.com/GeekGroveCode/vibesdk/commit/af1ba3155e458320abc6d67c60ca7e4276885ec4))
...
* use correct error field in deployment failure toast message ([dcf98a4](https://github.com/GeekGroveCode/vibesdk/commit/dcf98a4240447f79d5612d8f92284902fc144846))
...
* use templateName check instead of isInitialized() for agent start validation ([d9c7a30](https://github.com/GeekGroveCode/vibesdk/commit/d9c7a30732b5dcc5baf6c39635332ebe1030f9cd))
...
* optimize binary file detection and base64 encoding in zip extractor ([a6c67d0](https://github.com/GeekGroveCode/vibesdk/commit/a6c67d01be38e235207a647b83dd5dde0167dd49))
...
* optimize file writing with batched shell script to reduce API requests ([f4f4f7b](https://github.com/GeekGroveCode/vibesdk/commit/f4f4f7ba2ac441612f6cbae7a20e3c54da882231))
